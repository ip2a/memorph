...
pub(super) async fn list_agent_management() -> impl IntoResponse {
    match run_blocking(agent_management::list_agent_management_entries).await {
...
pub(super) async fn list_agent_management_summary() -> impl IntoResponse {
    match run_blocking(agent_management::list_agent_management_summaries).await {
        Ok(providers) => {
...
pub(super) async fn get_agent_management_provider(
    ...
    match run_blocking(move || agent_management::get_agent_management_entry(&provider)).await {
...
pub(super) async fn detect_agent_management_provider(
    ...
    match run_blocking(move || agent_management::detect_agent_management_entry(&provider)).await {
        Ok(provider) => {
