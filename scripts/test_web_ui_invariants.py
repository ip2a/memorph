...
class WebUiInvariantTest(unittest.TestCase):
    ...
    def test_workspace_switch_preserves_legacy_modal_workflow(self) -> None:
        ...
        for marker in [
            ...
            't("systemBrowse")',
            't("workspaceRemoveHistory")',
            't("workspaceSwitchToDirectory")',
    ...
    def test_import_session_preserves_legacy_modal_workflow(self) -> None:
        ...
        for marker in [
            ...
            't("importTargetProvider")',
            't("importFileOrId")',
            't("sessionTargetDirectory")',
            "known-workspaces",
            't("sessionBrowse")',
            't("import")',
            "selectFile",
    ...
    def test_picker_update_and_external_link_api_boundaries_exist(self) -> None:
        ...
        self.assertIn('t("importFilePickerDesktopOnly")', import_dialog)
        self.assertIn('t("importFolderPickerDesktopOnly")', import_dialog)
    ...
    def test_session_copy_export_preserve_legacy_row_and_detail_workflows(self) -> None:
        ...
        for marker in [
            ...
            't("sessionOutputFileName")',
            't("sessionFormat")',
            't("sessionExportDirectory")',
            "exportSession({",
            "result.files.join",
        ]:
            self.assertIn(marker, actions)
    ...
    def test_compression_route_preserves_legacy_two_panel_row_workflow(self) -> None:
        ...
        for marker in [
            "data-compression-page-layout",
            "data-compression-session-panel",
            "data-compression-archive-panel",
            "data-compression-session-row",
            "data-compression-archive-row",
            't("compressionCompressedSessions")',
            't("compressionArchives")',
            't("view")',
            't("resume")',
            "data-restore-compression-dialog",
            "data-compression-restore-archive-ref",
            'name="archive_ref"',
            't("compressionOutputPrefix")',
            "defaultRestorePrefix",
            "useRestoreCompressionArchive",
            "groupArchivesBySession",
        ]:
    ...
    def test_sync_detail_route_preserves_legacy_holding_workflow(self) -> None:
        ...
        for marker in [
            "SyncGroupDetailPanel",
            "data-sync-detail-panel",
            "data-sync-holdings-panel",
            "data-sync-detail-row-actions",
